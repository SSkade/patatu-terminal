...
# Recorrer los correos no leídos en la carpeta nuevamente para guardar los archivos adjuntos
for item in carpeta.Items:
    if item.UnRead and item.SenderEmailAddress == email_address:
...
enviar_correo(directorio_cliente_fecha, 'ankiellucian@gmail.com')
